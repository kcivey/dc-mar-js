...
class Client {
    ...
    request(operation, parameters) {
        ...
        const requestOptions = {
            ...
            params: Object.assign({}, parameters, {f: 'json'}), // avoid modifying argument
        };
        return this.pause()
    ...
    reverseLatLngGeocoding(lat, lng, raw) {
        const parameters = {lat, lng};
        return this.request('reverseLatLngGeocoding', parameters)
            .then(function (body) {
                if (raw) {
                    return body;
                }
                return body && body.Table1 ? body.Table1.map(properties => new Address(properties)) : [];
            });
    }
